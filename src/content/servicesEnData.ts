...
export const serviceContentEn: Record<string, ServiceContent> = {
  bitrix24: {
    ...
    bitrixCertificates: {
      ...
      items: [
        { id: 'cert-f1', src: '/certificates/certf1.webp', alt: 'Bitrix24 certificate — 1' },
        { id: 'cert-f2', src: '/certificates/certf2.webp', alt: 'Bitrix24 certificate — 2' },
        { id: 'cert-f3', src: '/certificates/certf3.webp', alt: 'Bitrix24 certificate — 3' },
        { id: 'cert-f4', src: '/certificates/certf4.webp', alt: 'Bitrix24 certificate — 4' },
        { id: 'cert-f5', src: '/certificates/certf5.webp', alt: 'Bitrix24 certificate — 5' },
        { id: 'cert-f6', src: '/certificates/certf6.webp', alt: 'Bitrix24 certificate — 6' },
        { id: 'cert-f7', src: '/certificates/certf7.webp', alt: 'Bitrix24 certificate — 7' },
        { id: 'cert-f8', src: '/certificates/certf8.webp', alt: 'Bitrix24 certificate — 8' },
        { id: 'cert-f9', src: '/certificates/certf9.webp', alt: 'Bitrix24 certificate — 9' },
      ],
    },
    groups: [
      {
